...
public class Mail {
	...
	public Mail(String to, String from, String nick, String host, String username, String password, String subject,
			String content) {
		this.to = to;
		this.from = from;
		this.nick = nick;
	...
	public boolean sendMail() {
		...
		try {
			...
			/**
			 * setRecipient（Message.RecipientType type, Address address），用于设置邮件的接收者。
			 * 有两个参数，第一个参数是接收者的类型，第二个参数是接收者。
			 * 接收者类型可以是
			 * Message.RecipientType.TO , TO表示主要接收人
