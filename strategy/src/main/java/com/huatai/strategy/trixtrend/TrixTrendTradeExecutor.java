...
public class TrixTrendTradeExecutor extends StrategyTradeExecutor<TrixTrendAnalysisResult> {
	private final IMarketDataCalculateService mdCalService;
	private final ITradingService tradingService;
	
	public TrixTrendTradeExecutor(IMarketDataCalculateService mdCalService, ITradingService tradingService) {
	...
	@Override
	public void execute(TrixTrendAnalysisResult result) throws Exception {
