...
public class ReverseTradeExecutor extends StrategyTradeExecutor<ReverseAnalysisResult> {
	...
	public ReverseTradeExecutor(ReverseDataCache dataCache, ISubscribeService subscribeService) {
