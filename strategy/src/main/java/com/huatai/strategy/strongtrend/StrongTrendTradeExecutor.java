...
public class StrongTrendTradeExecutor extends StrategyTradeExecutor<StrongTrendAnalysisResult> {
	private final IMarketDataCalculateService mdCalService;
	private final ITradingService tradingService;
	
	public StrongTrendTradeExecutor(IMarketDataCalculateService mdCalService, ITradingService tradingService) {
	...
	@Override
	public void execute(StrongTrendAnalysisResult result) throws Exception {
