...
public class CThostFtdcQryHisOrderField extends StructObject {
	...
	public CThostFtdcQryHisOrderField SettlementID(int SettlementID) {
		io.setIntField(this, 8, SettlementID);
		return this;
	}
	...
	public CThostFtdcQryHisOrderField(Pointer<? extends CPPObject> pointer) {
		super(pointer);
	}
}
