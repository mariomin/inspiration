...
public class CThostFtdcChangeAccountField extends StructObject {
	...
	public CThostFtdcChangeAccountField ErrorID(int ErrorID) {
		io.setIntField(this, 40, ErrorID);
		return this;
	}
	...
	public CThostFtdcChangeAccountField(Pointer<? extends CPPObject> pointer) {
		super(pointer);
	}
}
