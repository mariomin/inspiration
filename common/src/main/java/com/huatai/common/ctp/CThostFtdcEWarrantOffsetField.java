...
public class CThostFtdcEWarrantOffsetField extends StructObject {
	...
	public CThostFtdcEWarrantOffsetField HedgeFlag(byte HedgeFlag) {
		io.setByteField(this, 6, HedgeFlag);
		return this;
	}
	...
	public CThostFtdcEWarrantOffsetField(Pointer<? extends CPPObject> pointer) {
		super(pointer);
	}
}
