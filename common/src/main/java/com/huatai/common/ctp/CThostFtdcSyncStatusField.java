...
public class CThostFtdcSyncStatusField extends StructObject {
	...
	public CThostFtdcSyncStatusField DataSyncStatus(byte DataSyncStatus) {
		io.setByteField(this, 1, DataSyncStatus);
		return this;
	}
	...
	public CThostFtdcSyncStatusField(Pointer<? extends CPPObject> pointer) {
		super(pointer);
	}
}
