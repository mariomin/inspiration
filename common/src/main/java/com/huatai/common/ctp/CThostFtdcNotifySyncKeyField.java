...
public class CThostFtdcNotifySyncKeyField extends StructObject {
	...
	public CThostFtdcNotifySyncKeyField RequestID(int RequestID) {
		io.setIntField(this, 18, RequestID);
		return this;
	}
	...
	public CThostFtdcNotifySyncKeyField ErrorID(int ErrorID) {
		io.setIntField(this, 20, ErrorID);
		return this;
	}
	...
	public CThostFtdcNotifySyncKeyField(Pointer<? extends CPPObject> pointer) {
		super(pointer);
	}
}
