...
public class CThostFtdcLoginInfoField extends StructObject {
	...
	public CThostFtdcLoginInfoField IsQryControl(int IsQryControl) {
		io.setIntField(this, 20, IsQryControl);
		return this;
	}
	...
	public CThostFtdcLoginInfoField(Pointer<? extends CPPObject> pointer) {
		super(pointer);
	}
}
