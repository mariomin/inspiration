...
public class SuspendStrategyEvent extends AsyncEvent {
	private static final long serialVersionUID = 1L;
	private final StrategyAlterCommand strategyAlterCommand;
	
	public SuspendStrategyEvent(String key, StrategyAlterCommand strategyAlterCommand) {
		super(key);
	...
	public String toString() {
		...
		builder.append("SuspendStrategyEvent [strategyAlterCommand=");
