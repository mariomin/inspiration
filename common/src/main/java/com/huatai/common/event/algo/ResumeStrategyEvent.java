...
public class ResumeStrategyEvent extends AsyncEvent {
	private static final long serialVersionUID = 1L;
	private final StrategyAlterCommand strategyAlterCommand;
	
	public ResumeStrategyEvent(String key, StrategyAlterCommand strategyAlterCommand) {
		super(key);
	...
	public String toString() {
		...
		builder.append("ResumeStrategyEvent [strategyAlterCommand=");
