...
public class StrategyAlterCommandEvent extends AsyncEvent {
	private static final long serialVersionUID = 1L;
	private final StrategyAlterCommand strategyAlterCommand;
	
	public StrategyAlterCommandEvent(String key, StrategyAlterCommand strategyAlterCommand) {
		super(key);
	...
	public String toString() {
		...
		builder.append("StrategyAlterCommandEvent [strategyAlterCommand=");
