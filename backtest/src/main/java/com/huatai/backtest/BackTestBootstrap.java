...
@ImportResource(locations = { "classpath:backtest.xml" })
@RestController
@EnableAutoConfiguration(exclude = { DataSourceAutoConfiguration.class, HibernateJpaAutoConfiguration.class })
public class BackTestBootstrap extends SpringBootServletInitializer {
	...
	public ModelAndView overview() {
		return new ModelAndView("pages/BackTestReporting");
	}
	...
	public static void main(String[] args) throws Exception {
		ConfigurableApplicationContext context = SpringApplication.run(BackTestBootstrap.class, args);
